...
class RemindersViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RemindersManager.shared.updateLocation() // updating location as soon as app starts
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "\(reminder.coordinate.latitude), \(reminder.coordinate.longitude), \(reminder.radius), \(reminder.enter), \(reminder.exit)" // added the new data
